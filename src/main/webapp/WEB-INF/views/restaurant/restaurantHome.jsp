        ...
        <div class="container">
            <div class="row align-items-center text-center">
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="城市、餐廳名稱等" aria-label="Recipient's username" aria-describedby="basic-addon2">
                    <div class="input-group-append">
                        <button class="btn btn-outline-secondary" type="button">找餐廳</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 probootstrap-animate mb-3">
                    <a href="#" class="probootstrap-thumbnail">
                        ...
                        <img src="/startrip/assets/images/01.jpg" alt="Free Template by ProBootstrap.com" class="img-fluid">
                ...
                <div class="col-lg-3 col-md-6 probootstrap-animate mb-3">
                    <a href="#" class="probootstrap-thumbnail">
                        ...
                        <img src="/startrip/assets/images/02.jpg" alt="Free Template by ProBootstrap.com" class="img-fluid">
