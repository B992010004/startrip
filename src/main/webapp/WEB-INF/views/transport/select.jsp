...
//		}
	...
	<section>
		<div class="container">
			...
			<div class="row">
				<div>
					<a class="probootstrap-thumbnail"> <img id="imgMap"
						class="img-fluid" alt="Free Template by ProBootstrap.com"
						src="/startrip/assets/transport/images/taiwan.png"
		...
		{	
			...
			for(var i=0;i<response.length;i++){
				$("#tbo").append("<tr><td>"+response[i].area+ "</td>"+
								 	 ...
								 	 "<td >"+"<img class='mapImage' id='getAddress' width='30' height='30' src='/startrip/assets/transport/images/mapicon.png' onclick='f1()'><span>"+response[i].address+"</span></td></tr>");
			}
...
//---------------------------	
				...
				<div class="row">
					<div class="col-md">
						<!-- 地圖 -->
						<a href="https://maps.google.com/maps?q=$('#dynamicMap')&amp;z=11"
							data-geo="" target="_blank"> <img class="map"
							alt="$('#dynamicMap')"
							src="https://maps.google.com/maps/api/staticmap?zoom=15&size=300x300&maptype=terrain&sensor=false&center=$('#dynamicMap')&markers=color:green%7Clabel:H%7C$('#dynamicMap')&key=AIzaSyARfDct4ecrevMJjHgcrjmPOLfbM6X9N7w">
						</a>
					</div>
				</div>
			</div>
