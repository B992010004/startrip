...
GO
insert into TravelPlan (travelName,startDate,endDate,travelDays,memberId)values('ªá½¬','2015-02-05','2015-02-08',3,1);
insert into TravelPlan (travelName,startDate,endDate,travelDays,memberId)values('¥x¥_','2015-02-07','2015-02-21',14,1);
insert into TravelPlan (travelName,startDate,endDate,travelDays,memberId)values('¥x¥_','2015-02-07','2015-02-21',14,1);
