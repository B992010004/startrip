...
public class RestaurantReview implements Serializable {
	...
	public String toString() {
		return "RestaurantReview [no=" + no + ", articleId=" + articleId + ", restaurantId=" + restaurantId
				+ ", memberId=" + memberId + ", lastname=" + lastname + ", updateTime=" + updateTime + ", title="
				+ title + ", content=" + content + ", tripType=" + tripType + ", visited=" + visited + ", overallRank="
				+ overallRank + ", serviceRating=" + serviceRating + ", valueRating=" + valueRating + ", roomsRating="
				+ roomsRating + ", roomTips=" + roomTips + ", thumbCount=" + thumbCount + ", photoPaths=" + photoPaths
